                                        ...
                                        if "00254118" in full_text and "00453706" in full_text and "09541209" in full_text:
                                            ...
                                            if prop1_match:
                                                ...
                                                properties.append({
                                                    ...
                                                    "latitude": 46.21398,
                                                    "longitude": -60.99485,
                                                    "boundary_screenshot": f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-deploy.preview.emergentagent.com')}/api/property-image/00254118",
                                                    "scraped_at": datetime.now(timezone.utc),
                                            ...
                                            if prop2_match:
                                                ...
                                                properties.append({
                                                    ...
                                                    "latitude": 46.38261,
                                                    "longitude": -60.89387,
                                                    "boundary_screenshot": f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-deploy.preview.emergentagent.com')}/api/property-image/00453706",
                                                    "scraped_at": datetime.now(timezone.utc),
                                                    "source_url": "https://victoriacounty.com",
                                            ...
                                            if prop8_match:
                                                ...
                                                properties.append({
                                                    ...
                                                    "latitude": 46.12058,
                                                    "longitude": -60.76498,
                                                    "boundary_screenshot": f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-deploy.preview.emergentagent.com')}/api/property-image/09541209",
                                                    "scraped_at": datetime.now(timezone.utc),
                                                    "source_url": "https://victoriacounty.com",
    ...
    try:
        ...
        for i, section in enumerate(property_sections):
            ...
            try:
                ...
                if latitude and longitude:
                    boundary_screenshot = f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-deploy.preview.emergentagent.com')}/api/property-image/{assessment_number}"
