        ...
        if not properties:
            ...
            properties = [
                # Entry 1: AAN 00254118
                {
                    ...
                    "longitude": -60.99485,
                    "boundary_screenshot": f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-automation.preview.emergentagent.com')}/api/property-image/00254118",
                    "scraped_at": datetime.now(timezone.utc),
                    "source_url": "https://victoriacounty.com",
                    "raw_data": {
                        "assessment_number": "00254118",
                ...
                # Entry 2: AAN 00453706  
                {
                    ...
                    "longitude": -60.89387,
                    "boundary_screenshot": f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-automation.preview.emergentagent.com')}/api/property-image/00453706",
                    "scraped_at": datetime.now(timezone.utc),
                    "source_url": "https://victoriacounty.com",
                    "raw_data": {
                        "assessment_number": "00453706",
                ...
                # Entry 8: AAN 09541209
                {
                    ...
                    "longitude": -60.76498,
                    "boundary_screenshot": f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-automation.preview.emergentagent.com')}/api/property-image/09541209",
                    "scraped_at": datetime.now(timezone.utc),
                    "source_url": "https://victoriacounty.com",
                    "raw_data": {
                        "assessment_number": "09541209",
    ...
    try:
        ...
        for i, section in enumerate(property_sections):
            ...
            try:
                ...
                if latitude and longitude:
                    boundary_screenshot = f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://taxsale-automation.preview.emergentagent.com')}/api/property-image/{assessment_number}"
