        ...
        <div className="mb-6">
          ...
          <div className="border rounded-lg overflow-hidden">
            {property.boundary_screenshot ? (
              ...
              <img
                src={`https://maps.googleapis.com/maps/api/staticmap?center=${property.latitude},${property.longitude}&zoom=17&size=800x300&maptype=satellite&key=${process.env.REACT_APP_GOOGLE_MAPS_API_KEY || 'AIzaSyACMb9WO0Y-f0-qNraOgInWvSdErwyrCdY'}`}
                alt="Satellite view"
                className="w-full h-64 object-cover"
              />
            )}
