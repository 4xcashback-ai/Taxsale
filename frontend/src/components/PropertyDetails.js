          ...
          <div className="space-y-2">
            {property.pid_number && (
              <a
                ...
                className="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-colors mr-2 mb-2"
              >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition-colors mr-2 mb-2"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 transition-colors mr-2 mb-2"
            >
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <span className="text-gray-900">{property.owner_name || 'Not available'}</span>
            </div>
            <div>
              <span className="block text-sm text-gray-500 mb-1">Property Classification</span>
              <span className="text-gray-900">
                {propertyDetails?.property_type || 'Property Type Not Available'} 
