...
import { Search, MapPin, Calendar, DollarSign, Building2, BarChart3, RefreshCw, Download, Gavel, Users, Clock, Plus, Edit, Save, X, Home, Trash2, Check, Lock, LogIn, LogOut, FileText, Bookmark } from "lucide-react";
        ...
        {activeView === 'search' && (
          <div className="space-y-6">
            ...
            <div>
              ...
              {/* Pagination Controls */}
              {!loading && taxSales.length > 0 && totalPages > 1 && (
