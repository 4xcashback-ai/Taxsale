...
def test_vps_scraping_deployment_issues():
    ...
    try:
        ...
        test_origins = [
            "https://nstax-navigator.preview.emergentagent.com",
            "http://localhost:3000",
            "null"
        ]
        ...
        print(f"   🔧 Expected frontend URL: https://nstax-navigator.preview.emergentagent.com")
        
        # Verify the backend URL matches what frontend should be using
        expected_backend = "https://nstax-navigator.preview.emergentagent.com/api"
