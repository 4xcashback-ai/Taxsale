...
def test_vps_scraping_deployment_issues():
    ...
    try:
        ...
        test_origins = [
            "https://property-finder-89.preview.emergentagent.com",
            "http://localhost:3000",
            "null"
        ]
        ...
        print(f"   🔧 Expected frontend URL: https://property-finder-89.preview.emergentagent.com")
        
        # Verify the backend URL matches what frontend should be using
        expected_backend = "https://property-finder-89.preview.emergentagent.com/api"
