...
sudo tee /etc/systemd/system/tax-sale-backend.service << 'EOF'
[Unit]
...
1. **Access website**: `http://your-vps-ip`
2. **Login**: admin / TaxSale2025!SecureAdmin
3. **Test admin panel**: Should show scraping options
4. **Run scraper**: Test one municipality scraper
5. **Test Google Maps**: Should load without conflicts
