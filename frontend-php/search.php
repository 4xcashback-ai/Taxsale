                            ...
                            <div class="modal-body">
                                <form id="editPropertyForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="edit_latitude" placeholder="Latitude">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" id="edit_longitude" placeholder="Longitude">
                                            </div>
                                        </div>
                                        <div class="form-text">Useful for fixing thumbnail generation issues</div>
                                    </div>
                                </form>
                            </div>
